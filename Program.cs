...
namespace SFCC
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                System.Console.WriteLine("Usage: sfcc-catalog-inspector [options]\nCatalog inspector - use this to parse site and master catalog xml and output lists of all primary and classification category assignment for products as well as details for all variation products including their master product, size, color and if they are assigned to a category\n\nOptions:\n\t-s file\t\tspecify xml file for site catalog (defaults to site-catalog.xml otherwise)\n\t-m file\t\tspecify xml file for master catalog (defaults to master-catalog.xml)\n\t-h\t\tthis help menu\n\nExamples:\n./sfcc-catalog-inspector\n./sfcc-catalog-inspector -s C:\\some\\path\\site-catalog-my-site.xml -m C:\\other\\path\\master-catalog.xml");
                return;
            }
